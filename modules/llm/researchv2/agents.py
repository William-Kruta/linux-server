...
class Agent:
    """
    The base class for all research agents. It provides core functionalities
    like interacting with the LLM and using tools.
    """

    def __init__(self, model_name: str, system_prompt: str):
        """
        Initializes the agent with a specific LLM and a system prompt defining its role.

        Args:
            model_name: The name of the Ollama model to use (e.g., 'llama3').
            system_prompt: The system prompt that defines the agent's persona and task.
        """
...
"""
    ...
    def run(self, task: str, search_query: str = None) -> str:
        """
